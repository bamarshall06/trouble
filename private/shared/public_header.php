...
<html>
  <head>
    ...
    <title>Bryan's Blog Manager | <?php echo $page_title; //gets the $page_title from the page and puts it here ?></title>
    <link rel="stylesheet" href="http://bryanmarshall.com/prog/trouble/public/stylesheets/styles.css?modified=211115712">
    <style>
    .owe {color: red; }
    .refund { color: green; }
    </style>
